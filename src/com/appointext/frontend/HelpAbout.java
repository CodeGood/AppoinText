...
public class HelpAbout extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		text.setText("Welcome to Appointext!\n\n" +
					 "AppoinText is a simple(to use, not to develop. :P) application that understands the reads your messages and auto generates reminders if it find that a reminder will be necessary");
